...
adminRouter.post("/rooms", adminController.createRoom);
adminRouter.patch("/rooms/:roomId", adminController.updateRoom);
...
adminRouter.get("/bank-accounts", adminController.bankAccounts);
adminRouter.post("/bank-accounts", adminController.createBankAccount);
adminRouter.patch("/bank-accounts/:accountId", adminController.updateBankAccount);
adminRouter.delete("/bank-accounts/:accountId", adminController.deleteBankAccount);
